...
class Trader:
    ...
    # Toggle for ablation: if False, the exploit is disabled entirely.
    EXPLOIT_ENABLED = True
    # Toggle for ablation: if False (default), use generic per-name buy-share
    # detection. If True, only treat the literal name "Mark 01" as the noise
    # buyer (used to verify name-agnostic behaves the same).
