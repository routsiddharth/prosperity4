...
5-sleeve microchip mean-reversion (basket3, basket4, TRI idio, RECT MR,
OVAL idio) gated by a priority + partial budget manager. Single trading
day; state resets when timestamp returns to 0.
...
PARAMS = {
    ...
    "E_oval_idio": {
        "kind": "idio", "priority": 5, "target": "MICROCHIP_OVAL",
        "window": 1000, "z_entry": 1.5, "exit_mode": "opposite",
        "direction": "both", "max_units": 2,
        "max_hold": 1000, "z_stop": 4.0,
        "warmup_mode": "off", "w_short": 200, "z_short": 3.0,
        "pre_warmup_max_units": 1, "pre_warmup_max_hold": 300,
    },
}

SLEEVE_ORDER = ["A_basket3", "B_basket4", "C_tri_idio", "D_rect_mr", "E_oval_idio"]
