...
class Trader:
    ...
    # IPR parameters
    IPR_TAKE_OFFSET = 8  # lift asks at or below estimated fair + this offset
    ...
    def _run(
        ...
        trader_data = json.dumps({"ipr_base": ipr_base, "aco_mid": aco_prev_mid})
    ...
    def ipr_orders(
        ...
        threshold = fair + cls.IPR_TAKE_OFFSET
