"""
test29: Uniform ladder (D=14, S=5) + flatten-at-fair logic.
"""
import json
...
class Trader:
    ...
    FAIR = 10000
    BID_LADDER = [(offset, 5) for offset in range(14, 0, -1)]
    ASK_LADDER = [(offset, 5) for offset in range(14, 0, -1)]
    ...
    def aco(cls, product, od, bb, ba, pos, limit):
        ...
        # Flatten at fair if book has counterparty
