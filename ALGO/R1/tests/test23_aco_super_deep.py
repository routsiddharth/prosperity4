"""
test23: Super-deep ladder (offsets up to 20) to catch rare but very high-edge trades.
"""
import json
...
class Trader:
    ...
    # 20 levels each side, small sizes. Deepest first.
    BID_LADDER = [(20 - i, 3) for i in range(20)]  # offsets 20, 19, ..., 1
    ASK_LADDER = [(20 - i, 3) for i in range(20)]
