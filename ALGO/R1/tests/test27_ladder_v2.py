"""
test27: Pure ladder v2. Bigger sizes, deeper.
"""
import json
...
class Trader:
    ...
    FAIR = 10000
    # Deepest first. Each offset has size. Ensure total <= 80.
    BID_LADDER = [(20, 5), (15, 5), (10, 5), (7, 5), (5, 10), (3, 10), (2, 15), (1, 25)]   # total 80
    ASK_LADDER = [(20, 5), (15, 5), (10, 5), (7, 5), (5, 10), (3, 10), (2, 15), (1, 25)]
