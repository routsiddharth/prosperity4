"""
test20: Extended ladder. 14 levels fair-14..fair-1 with size 5 each (total 70 per side).
Asymmetric sizing: bigger chunk at fair±1 to catch frequent small-edge fills.
"""
import json
...
class Trader:
    ...
    # Ladder tiers (offset, size). Deepest first for market-trade priority.
    BID_LADDER = [(14, 3), (13, 3), (12, 3), (11, 3), (10, 3), (9, 3), (8, 3),
                  (7, 3), (6, 3), (5, 3), (4, 3), (3, 3), (2, 5), (1, 20)]  # total 61
