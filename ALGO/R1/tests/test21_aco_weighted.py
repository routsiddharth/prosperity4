"""
test21: Ladder with sizes concentrated where market-trade volume peaks.
From day -1 data: aggressor-sell vol peaks at 9992-9995, aggressor-buy at 10007-10010.
"""
import json
...
class Trader:
    ...
    FAIR = 10000
    # Size at each (offset, size). Deep first. Total 60 each.
    BID_LADDER = [(15, 2), (12, 3), (10, 4), (8, 5), (6, 6), (5, 6), (4, 8), (3, 8), (2, 8), (1, 10)]
    ASK_LADDER = [(15, 2), (12, 3), (10, 4), (8, 5), (6, 6), (5, 6), (4, 8), (3, 8), (2, 8), (1, 10)]
